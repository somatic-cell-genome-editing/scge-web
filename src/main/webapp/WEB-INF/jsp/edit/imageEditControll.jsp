...
<%
    ...
    List<Image> images = imageCheckIDao.getImage(objectId,bucket);
      ...
      if (imageCheckAccess.isAdmin(imageCheckPerson)) { %>
        ...
        <table align="center"><tr><td><a href="javascript:return void(0)" onclick="document.getElementById('<%=bucket%>form').style.display='block'; this.style.display='none';">Add image...</a></td></tr>
        <% } %>
