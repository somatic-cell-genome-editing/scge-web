...
<c:if test="${action!=null && action=='About SCGE Toolkit'}">
    <div class="container-fluid  jumbotron"  id="home-page-search" style="background-color: #f7f8fa;padding-top: 20px;padding-bottom: 20px">
        <div class="row">
            <div class="col-lg-8">
               <p>The Somatic Cell Gene Editing (SCGE) Consortium is supported by the NIH Common Fund through cooperative agreements by multiple National Institutes of Health (NIH) institutes to advance genome editing technologies to the clinic. In addition to five additional scientific initiatives (below), the SCGE Dissemination and Coordinating Center (DCC) was funded (U24HG010423) to facilitate consortium interactions and scientific exchange and to collect and disseminate consortium generated data through the SCGE Toolkit to the broader biomedical research community.  </p>
                <hr class="my-4">
                <p>The Toolkit collects data and metadata from funded consortium laboratories, reviews, curates and standardizes data for loading into the Toolkit, works with the submitting laboratory and NIH program staff to certify data loading, and then makes data publicly accessible.  </p>
            </div>
            <div class="col">
