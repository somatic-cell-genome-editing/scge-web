...
<div class="container-fluid  jumbotron"  id="home-page-search" style="background-color: #f7f8fa;padding-top: 20px;padding-bottom: 20px">
    ...
    <div>
        ...
        <hr class="my-4">
        <p>The Somatic Cell Genome Editing (SCGE) Toolkit team works cooperatively with funded groups to facilitate their scientific endeavors by building pipelines and processes to collect, integrate, visualize, and distribute data, including </p>
            <div>
                <ul>
