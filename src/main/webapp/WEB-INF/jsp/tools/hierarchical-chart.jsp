...
<style>
  ...
  <script type="text/javascript">
    ...
    function drawChart() {
      ...
      data.addRows([
        [{'v':'SCGE Toolkit', 'f':'<span style="white-space: nowrap" class="card-label">Browse</span><img src="/toolkit/images/scge-logo-200w.png" width="150" style="padding-top: 0;margin-top: 0" alt="SCGE"/><br>'},
          '', 'SCGE Toolkit'],
        ...
        ['<a class="nav-link text-secondary" href="/toolkit/data/search/results/Guide?searchTerm="><img src="/toolkit/images/guide.png"   class="card-image" alt=""/><br><span style="white-space: nowrap" class="card-label">Guides</span><br>Guide RNAs function as guide for targeting enzymes with which it forms complexes.</a>', 'Experiments', 'Guide RNAs'],
