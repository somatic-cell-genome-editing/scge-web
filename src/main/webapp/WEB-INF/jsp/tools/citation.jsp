...
<b>Note:</b> Reporting use of Toolkit data should kindly acknowledge the originating laboratory and include the date of access.<br>
        <span style="text-decoration: underline;">Example:</span> The Somatic Cell Gene Editing Consortium Toolkit (https://scge.mcw.edu/toolkit) was accessed on ##/##/#### to obtain data deposited by the laboratory of Dr. Jane Smith for our comparisons.
</div>
</div>
