            ...
            <div class="col-md-6">
                <table  class='borderless'>
                    <tr>
                        ...
                        <td><a href="studies/search"><strong>Submissions</strong></a>, innovative approaches to deliver genome editing machinery into somatic cells, with the ultimate goal of accelerating the development of genome editing therapeutics to treat human disease.</td>
                    </tr>
                </table>
            </div>
            <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <table  class='borderless'>
                        <tr>
                            ...
                            <td><a  href="vitro/search"><strong>Bilogical Effects</strong></a> observed during the development, validation and testing of new and existing human cell- and tissue-based platforms. These models will be used for preclinical testing of editing, delivery and efficacy.</td>
                        </tr>
                    </table>
                </div>
        </div>
