...
<table align="center" >
    ...
    <td style="padding-bottom:5px;font-size:16px;font-family: 'Roboto', sans-serif;">We make data generated by participating laboratories across <span style="font-weight:700;">five consortium initiatives</span> publicly accessible</td>
        </tr>
    <tr>
        <td valign="top"><img src="/toolkit/images/bullet_30.png?" style="padding-left:25px;padding-right:10px;"/></td>
