...
<table width="70%" align="center">
    <tr>
        <td colspan="2">
            <b style="color:black;font-size:26px;font-family: 'Roboto', sans-serif;">What you need to know about the SCGE</b>
        </td>
        <tr>
            <td valign="top"><img src="/toolkit/images/bullet_30.png" style="padding-left:25px;padding-right:10px;"/></td>
            <td style="padding-bottom:5px;font-size:18px;font-family: 'Roboto', sans-serif;">We make data generated by participating laboratories across <span style="font-weight:700;">five consortium initiatives publicly accessible</span></td>
        </tr>
    <tr>
        <td valign="top"><img src="/toolkit/images/bullet_30.png?" style="padding-left:25px;padding-right:10px;"/></td>
    ...
    <tr>
        <td valign="top"><img src="/toolkit/images/bullet_30.png" style="padding-left:25px;padding-right:10px;"/></td>
        <td style="padding-bottom:5px;font-size:18px;font-family: 'Roboto', sans-serif;">We showcase development and <span style="font-weight:700;">independent validation of novel Delivery Systems</span> using unique preclinical Model Systems</td>
    </tr>
    <tr>
        <td valign="top"><img src="/toolkit/images/bullet_30.png" style="padding-left:25px;padding-right:10px;"/></td>
