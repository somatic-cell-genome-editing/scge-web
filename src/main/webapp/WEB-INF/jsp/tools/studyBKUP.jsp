...
<table id="myTable" class="table tablesorter table-striped">
    ...
    <c:forEach items="${studies}" var="rec">
        <tr>
            ...
            <c:if test="${userName!=null}">
            <td> <div class="col  tiers">
                <input type="button" id="updateTier-study${rec.studyId}" class="form-control" onclick="changeAccess($(this),${rec.studyId} )" value="Update Tier">
            </div></td>
            <td style="width: 10%">
                        ...
                        <div class="col tiers">
                            ...
                            <c:choose>
                                <c:when test="${studyId==rec.studyId}">
                                    <c:if test="${tier=='1'}">
                                        <select name="tier" class="tiers" id="select${rec.studyId}" onchange="changeAccess($(this),${rec.studyId} )" >
                                    ...
                                    <c:if test="${tier=='2'}">
                                        <select name="tier" class="form-control tiers" id="select${rec.studyId}" onchange="changeAccess($(this),${rec.studyId} )">
