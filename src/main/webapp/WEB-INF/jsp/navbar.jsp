...
<!--c:if test="$-{action==null}"-->
    <li class="nav-item dropdown">
        <div class="btn-group">
            <button type="button" class="btn"><a href="/toolkit/data/initiatives" style="color:#FFFFFF;">About SCGE</a></button>
        </div>

    </li>
                <li class="nav-item text-responsive">
                    <a class="nav-link" href="https://scge.mcw.edu/" style="font-weight: 400;">
                        <i class="fas fa-home"></i>Consortium Home</a>
                </li>
