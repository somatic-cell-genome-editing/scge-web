                ...
                <div class="fusion-row">
                    ...
                    <ul id="menu-main-menu" class="fusion-menu">
                        ...
                        <li  id="menu-item-749"  class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-749 fusion-megamenu-menu"  data-item-id="749"><a  href="#" class="fusion-flex-link fusion-bar-highlight"><span class="fusion-megamenu-icon"><i class="glyphicon fa-bezier-curve fas"></i></span><span class="menu-text">Goals by Initiatives</span></a><div class="fusion-megamenu-wrapper fusion-columns-5 columns-per-row-5 columns-5 col-span-10"><div class="row"><div class="fusion-megamenu-holder" style="width:999.996px;background-image: url(https://scge.mcw.edu/wp-content/uploads/2019/04/286-40-grey-blue-squares-HUD-gear-FULL.jpg);" data-width="999.996px"><ul role="menu" class="fusion-megamenu">
                            ...
                            <li  id="menu-item-418"  class="menu-item menu-item-type-post_type menu-item-object-page menu-item-418 fusion-megamenu-submenu fusion-megamenu-columns-5 col-lg-2 col-md-2 col-sm-2"  style="width:20%;"><div class='fusion-megamenu-title'><a href="https://scge.mcw.edu/genomeeditor/">Genome Editor Projects</a></div><div class="fusion-megamenu-widgets-container second-level-widget"><div id="media_image-6" class="widget widget_media_image"><a href="https://scge.mcw.edu/genomeeditor/"><img width="100" height="100" src="https://scge.mcw.edu/wp-content/uploads/2019/06/Editor-rev.png" class="image wp-image-1110  attachment-100x100 size-100x100" alt="" style="max-width: 100%; height: auto;" srcset="https://scge.mcw.edu/wp-content/uploads/2019/06/Editor-rev-66x66.png 66w, https://scge.mcw.edu/wp-content/uploads/2019/06/Editor-rev.png 134w" sizes="(max-width: 100px) 100vw, 100px" /></a></div></div></li>
                            <li  id="menu-item-417"  class="menu-item menu-item-type-post_type menu-item-object-page menu-item-417 fusion-megamenu-submenu fusion-megamenu-columns-5 col-lg-2 col-md-2 col-sm-2"  style="width:20%;"><div class='fusion-megamenu-title'><a href="https://scge.mcw.edu/dissemination/">Dissemination and Coordinating Center</a></div><div class="fusion-megamenu-widgets-container second-level-widget"><div id="media_image-5" class="widget widget_media_image"><a href="https://scge.mcw.edu/dissemination/"><img width="100" height="100" src="https://scge.mcw.edu/wp-content/uploads/2019/03/DCC.png" class="image wp-image-160  attachment-100x100 size-100x100" alt="" style="max-width: 100%; height: auto;" srcset="https://scge.mcw.edu/wp-content/uploads/2019/03/DCC-27x27.png 27w, https://scge.mcw.edu/wp-content/uploads/2019/03/DCC-66x66.png 66w, https://scge.mcw.edu/wp-content/uploads/2019/03/DCC.png 134w" sizes="(max-width: 100px) 100vw, 100px" /></a></div></div></li>
                        </ul>
                        </div>
                            <div style="clear:both;"></div></div></div>
                        </li>
                        <li  id="menu-item-1091"  class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-1091 fusion-megamenu-menu"  data-item-id="1091"><a  target="_blank" rel="noopener noreferrer" href="#" class="fusion-flex-link fusion-bar-highlight"><span class="fusion-megamenu-icon"><i class="glyphicon fa-diagnoses fas"></i></span><span class="menu-text">News &#038; Events</span></a><div class="fusion-megamenu-wrapper fusion-columns-2 columns-per-row-2 columns-2 col-span-4"><div class="row"><div class="fusion-megamenu-holder" style="width:399.9984px;background-image: url(https://scge.mcw.edu/wp-content/uploads/2019/04/286-40-grey-blue-squares-HUD-gear.jpg);" data-width="399.9984px"><ul role="menu" class="fusion-megamenu">
